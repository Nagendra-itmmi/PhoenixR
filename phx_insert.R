...
phx_insert = function(key, table_name, file_path, usr)
{
  # DESCRIPTION: 
  ...
  # 
  # OUTPUT: 
  #   element_status- dataframe, composed of each element’s id and the status of its insert (all successful regardless) 
  # 
  # FUNCTION BODY:
  ...
  {
    temp = phx_write(key, paste0("COPY INTO ", table_name, " ON_ERROR = CONTINUE PURGE = TRUE;"), usr)
